...
每个 Phase 开始前必须 Read 对应加载文件：

| Phase | 加载 |
|---|---|
| §1 | `renderers/mermaid.md` + `renderers/svg.md` |
| §2 | `methods/reverse-learning.md` |
| §3 | `methods/first-principles.md` |
| §4 | `renderers/html-shell.md` |
| §5 | `methods/feynman.md` |
| §6 | `methods/socratic.md` |
| §7 | — |

**分批规则**（见 `core/rules.md` 规则 12）：单次不超 3 个 Phase，写完暂停等确认。
